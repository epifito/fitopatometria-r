...
```{r}
poroto %>%  rio::export("data/poroto.csv")
...
Ensayo de fungicidas en cebada (trt=3). 
DBCA con 4 rep.
...
#   rio::export("data/cebada_redu.csv")
# 
cebada  <- rio::import("data/cebada_redu.csv")
cebada <- read.csv("https://raw.githubusercontent.com/epifito/fitopatometria-r/main/data/cebada_redu.csv")
```
